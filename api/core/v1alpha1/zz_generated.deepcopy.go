...
import (
	"github.com/openmcp-project/controller-utils/api/jsonpatch"
...
func (in *ClusterConfigSpec) DeepCopyInto(out *ClusterConfigSpec) {
	*out = *in
	...
	if in.Patches != nil {
		...
		*out = make(jsonpatch.JSONPatches, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *PatchOptions) DeepCopyInto(out *PatchOptions) {
	*out = *in
	if in.IgnoreMissingOnRemove != nil {
		in, out := &in.IgnoreMissingOnRemove, &out.IgnoreMissingOnRemove
		*out = new(bool)
		**out = **in
	}
	if in.CreateMissingOnAdd != nil {
		in, out := &in.CreateMissingOnAdd, &out.CreateMissingOnAdd
		*out = new(bool)
		**out = **in
	}
}
...
func (in *ProviderConfigSpec) DeepCopyInto(out *ProviderConfigSpec) {
	*out = *in
	...
	if in.EnforcedShootExtensions != nil {
		in, out := &in.EnforcedShootExtensions, &out.EnforcedShootExtensions
		*out = make([]v1beta1.Extension, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
